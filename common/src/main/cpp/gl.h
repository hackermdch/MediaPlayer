 ...
 *
 * Commandline:
 *    --api='gl:compatibility=4.6' --extensions='GL_EXT_memory_object,GL_EXT_memory_object_win32' c
 *
 * Online:
 *    http://glad.sh/#api=gl%3Acompatibility%3D4.6&extensions=GL_EXT_memory_object%2CGL_EXT_memory_object_win32&generator=c&options=
 *
 */
