...
namespace jni
{
	...
	private:
		...
		jlong getFieldValue(field_t field, internal::ReturnTypeWrapper<jlong> const&) const;
	...
	public:
		...
		template <class... TArgs>
		Object newInstance(const char* sig, const TArgs&... args) const {
			method_t constructor = getMethod("<init>", sig);
			return newInstance(constructor, args...);
		}
		/**
